	...
	useEffect(() => {
		if(contentJson === null){
			...
			const deleteContent = async () => {
				...
				const deleteResult = await postFetch.deleteContent("unknown", sendData);
					...
					<div style={{margin: 10}}>
						...
						*/}
						...
						<div style={{display: "flex", justifyContent: "center", marginTop: "30px"}}>
							...
							&nbsp;&nbsp;
							<Button id={"downvoteButton"} onClick={() => {downvoteContent()}} variant="outline-danger" style={{width: "30%", maxWidth: "130px", padding: "2px"}}>
